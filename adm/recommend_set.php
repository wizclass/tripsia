...
if ($w=="S"){
		$gb_mb = "Select count(mb_brecommend) as bcnt from g5_member where mb_brecommend = '".$set_id."'";
	$a = sql_fetch($gb_mb);
	echo $a['bcnt'];
	if($a['bcnt'] >=2) {
		alert('Placement is not completed.');
	}
...
<div style="padding:20px 10px 20px 10px">
		...
		<form name="tForm" id="tForm" action="recommend_set.php" method="post">
