...
if ($w == 'c') // 댓글 입력
{
    ...
    */
    ...
    if ($config['cf_email_use'] && $board['bo_use_email'])
    {
        ...
        $link_url = get_pretty_url($bo_table, $wr_id, $qstr."#c_".$comment_id,'',G5_ADMIN_BBS_URL);
...
$redirect_url = short_url_clean(G5_ADMIN_HTTPS_BBS_URL.'/board.php?bo_table='.$bo_table.'&amp;wr_id='.$wr['wr_parent'].'&amp;'.$qstr.'&amp;#c_'.$comment_id);
