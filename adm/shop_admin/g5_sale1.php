...
<div class="local_sch02 local_sch">
    ...
    <div>
        <form name="frm_sale_today" action="./g5_sale1today.php" method="get">
        <strong>일일 매출</strong>
    ...
    <div>
        <form name="frm_sale_date" action="./g5_sale1date.php" method="get">
        <strong>일간 매출</strong>
    ...
    <div>
        <form name="frm_sale_month" action="./g5_sale1month.php" method="get">
        <strong>월간 매출</strong>
    ...
    <div class="sch_last">
        <form name="frm_sale_year" action="./g5_sale1year.php" method="get">
        <strong>연간 매출</strong>
