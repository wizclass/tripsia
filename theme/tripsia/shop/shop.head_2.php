...
if(G5_IS_MOBILE) {
    include_once(G5_THEME_MSHOP_PATH.'/shop.head_2.php');
    return;
}
// 헤드
...
.Grp {width:1200px;margin: 150px auto 10px;}
</style>
...
<header style="display:none;"> <!-- display:none-->
...
if (!defined('_INDEX_') && !defined('_SUB_')) {
	@include_once(G5_THEME_PATH."/shop/sub.head_2.php");
}
?>
<style type="text/css">
/* ## 게시판 타이틀 죽이기 */
