...
<h2 id="container_title"><?php echo ($board['bo_mobile_subject'] ? $board['bo_mobile_subject'] : $board['bo_subject']) ?><span class="sound_only"> List</span></h2>
...
<div id="bo_list<?php if ($is_admin) echo "_admin"; ?>">
    ...
    <div class="bo_fx">
        ...
        <ul class="btn_bo_user">
            ...
            <?php if ($write_href) { ?><li><a href="<?php echo $write_href ?>" class="btn_b02">Writing</a></li><?php } ?>
        </ul>
        <?php } ?>
    </div>
        ...
        <tr class="<?php if ($list[$i]['is_notice']) echo "bo_notice"; ?>">
            ...
            <td class="td_subject">
                ...
                <a href="<?php echo $list[$i]['href'] ?>">
                    ...
                    <?php if ($list[$i]['comment_cnt']) { ?><span class="sound_only">comment</span><?php echo $list[$i]['comment_cnt']; ?><span class="sound_only">개</span><?php } ?>
                    <?php
    ...
    <div class="bo_fx">
        ...
        <ul class="btn_bo_user">
            <li><?php if ($write_href) { ?><a href="<?php echo $write_href ?>" class="btn_b02">Writing</a><?php } ?></li>
        </ul>
    </div>
    <?php } ?>
    </form>
...
<fieldset id="bo_sch">
    ...
    <select name="sfl">
        ...
        <option value="wr_subject||wr_content"<?php echo get_selected($sfl, 'wr_subject||wr_content'); ?>>Title+내용</option>
        <option value="mb_id,1"<?php echo get_selected($sfl, 'mb_id,1'); ?>>원아이디</option>
        <option value="mb_id,0"<?php echo get_selected($sfl, 'mb_id,0'); ?>>원아이디(코)</option>
