...
<div id="bo_list">
    ...
    <div class="bo_fx">
        ...
        <ul class="btn_bo_user">
            ...
            <?php if ($write_href) { ?><li><a href="<?php echo $write_href ?>" class="btn_b02">Contact registration</a></li><?php } ?>
        </ul>
        <?php } ?>
    </div>
    <!-- } 게시판 페이지 정보 및 버튼 끝 -->
    ...
    <div class="ul_wrap ul_01">
        <ul>
            ...
            <li class="bo_li<?php if ($is_checkbox) echo ' bo_adm'; ?>">
                ...
                <div class="li_stat <?php echo ($list[$i]['qa_status'] ? 'txt_done' : 'txt_rdy'); ?>"><?php echo ($list[$i]['qa_status'] ? '답변완료' : 'Answer waiting'); ?></div>
            </li>
            <?php
            }
            ?>
