...
<aside id="ol_before" class="ol">
    ...
    <fieldset>
        ...
        <div id="ol_svc">
            ...
            <label for="auto_login" id="auto_login_label">Automatic login</label>
...
$("#auto_login").click(function(){
    if (this.checked) {
        this.checked = confirm("Automatic login을 사용하시면 다음부터 회원아이디와 비밀번호를 입력하실 필요가 없습니다.\n\n공공장소에서는 개인정보가 유출될 수 있으니 사용을 자제하여 주십시오.\n\nAutomatic login을 사용하시겠습니까?");
    }
});
