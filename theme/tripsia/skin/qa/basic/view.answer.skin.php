...
<section id="bo_v_ans">
    ...
    <div id="ans_add">
        ...
        <a href="<?php echo $answer_update_href; ?>" class="btn_b01">답변Modify</a>
        <?php } ?>
        <?php if($answer_delete_href) { ?>
        <a href="<?php echo $answer_delete_href; ?>" class="btn_b01" onclick="del(this.href); return false;">답변delete</a>
        <?php } ?>
    </div>
</section>