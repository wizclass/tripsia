...
<article id="bo_v">
    <header>
        <h1 id="bo_v_title">
            <?php
            echo $view['category'].' | '; // Classification 출력 끝
            echo $view['subject']; // 글Title 출력
            ?>
        </h1>
    </header>
    ...
    <section id="bo_v_info">
        <h2>페이지 정보</h2>
        Writer <strong><?php echo $view['name'] ?></strong>
    ...
    <section id="bo_v_rel">
        ...
        <div class="tbl_head01 tbl_wrap">
            ...
            <tr>
                ...
                <td class="td_stat <?php echo ($list[$i]['qa_status'] ? 'txt_done' : 'txt_rdy'); ?>"><?php echo ($rel_list[$i]['qa_status'] ? '답변완료' : 'Answer waiting'); ?></td>
