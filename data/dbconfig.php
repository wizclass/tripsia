...
define('G5_MYSQL_PASSWORD', 'wizclass235689!@');
define('G5_MYSQL_DB', 'tripsia');
...
define('wallet_TABLE_PREFIX', 'wallet_');
$g5['bonus'] = 'soodang_pay'; // 수당 테이블
$g5['bonus_config'] = wallet_TABLE_PREFIX.'bonus_config'; // 수당설정 테이블
$g5['withdrawal'] = wallet_TABLE_PREFIX.'withdrawal_request'; // 출금요청 테이블
$g5['deposit'] = wallet_TABLE_PREFIX.'deposit_request'; // 입금요청 테이블
$g5['coin_price'] = wallet_TABLE_PREFIX.'coin_price'; // 통화설정
$g5['wallet_config'] = wallet_TABLE_PREFIX.'config'; // 입출금설정
$g5['mining'] = 'soodang_mining'; // 마이닝
$g5['g5_item_table'] = G5_TABLE_PREFIX.'item'; // 상품 테이블
$g5['g5_order_table'] = G5_TABLE_PREFIX.'order'; // 주문서 테이블
$g5['g5_category_table'] = G5_TABLE_PREFIX.'category'; // 상품분류 테이블
?>