...
<aside id="ol_after">
    ...
    <div id="ol_after_hd" class="ol">
        ...
        <a href="<?php echo G5_BBS_URL ?>/point.php"  class="point"><strong><?php echo $point ?></strong>  포인트
        </a>
        <div id="ol_after_btn">
    ...
    <ul id="ol_after_private">
        <li id="ol_after_memo">
            <a href="<?php echo G5_BBS_URL ?>/memo.php?location=shop" >
                <i class="fa fa-envelope" aria-hidden="true"></i>쪽지
                <strong><?php echo $memo_not_read; ?></strong>
            </a>
        </li>

        <li><a href="<?php echo G5_SHOP_URL ?>/coupon.php" ><i class="fa fa-ticket" aria-hidden="true"></i>쿠폰<strong><?php echo number_format(get_shop_member_coupon_count($member['mb_id'], true)); ?></strong></a></li>
    </ul>
